...
<div id="diverror" class="alert alert-danger hidden">
    ...
    <ul id="uerror">
        ...
        <form id="myform" action="createstudentjson" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            ...
            <fieldset class="well the-fieldset">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 ">
                        <input type="text" class="form-control" placeholder="الرقم الجامعي" maxlength="9" id="stdid" name="stdid" value="{{ old('stdid') }}"  />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" placeholder="اسم الطالب " maxlength="50" id="fname" name="fname" value="{{ old('fname') }}"  />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" placeholder="الهاتف" maxlength="15" id="mobile" name="mobile" value="{{ old('mobile') }}"  />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" placeholder="المانح" maxlength="50" id="donor" name="donor" value="{{ old('donor') }}"  />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" placeholder="المنطقة" maxlength="50" id="country" name="country" value="{{ old('country') }}"  />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" placeholder="التحويلة" maxlength="4" id="extension" name="extension" value="{{ old('extension') }}"  />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" placeholder="الغرفة" maxlength="3" id="roomno" name="roomno" value="{{ old('roomno') }}"  />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <img id="imgview" src="#" alt="your image" width="350px" />
...
@section('scriptcontent')
    <script type="text/javascript">
        ...
        $(document).ready(function () {//called after load the page
            ...
            var urlrequest='createstudentjson';
